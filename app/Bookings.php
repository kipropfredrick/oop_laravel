...
{
  protected $fillable = ['product_id','county_id','location_id','customer_id','payment_mode','date_started','due_date','total_cost','setdate','setreminder','referal_code','branch_id','activated_at'];
