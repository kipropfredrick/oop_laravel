...
class FrontPageController extends Controller
{
    ...
    public function category($slug){
        ...
        $products = \App\Products::with('influencer','category','subcategory','gallery')->where('category_id','=',$category->id)
                                    ->where(function($q){    
                                        $q->where('vendor_id' , '!=', null)
                                        ->orWhere('agent_id' , '!=', null)
                                        ->orWhere('influencer_id' , '!=', null);
    ...
    public function shop($id){
        ...
        $products = \App\Products::with('influencer','category','subcategory','gallery')->where('influencer_id','=',$id)
                                    ->where(function($q){    
                                        $q->where('vendor_id' , '!=', null)
                                        ->orWhere('agent_id' , '!=', null)
                                        ->orWhere('influencer_id' , '!=', null);
    ...
    public function checkout_bonga_existing(Request $request, $slug){
        ...
        public function make_booking_bonga(Request $request){
            ...
            if (!$msisdn or $network != 'safaricom') {
            ...
            if($showDiscount == 1){
                ...
                $message = "Booking of : ".$product->product_name." was successful, Product Price is ".$product->product_price.", Shipping Cost ".$shipping_cost." You recieved a discount of ".number_format($discount,2)." Total Price is KES ".number_format(($total_cost),2)." And the Payment period is 90 Days ".", Dial *126# and select “Lipa Na Bonga” and move to enter  Pay bill , Enter : (4029165) and Account Number : ".$booking_reference.", Enter Amount you wish to pay. Terms & Conditions Apply";
                $this->sendMessage($message,$reciepient);
            
            }elseif($showDiscount == 0){
    
                $message = "Booking of : ".$product->product_name." was successful, Product Price is ".$product->product_price.", Shipping Cost ".$shipping_cost. ", Total Price is KES ".number_format($total_cost,2)." And the Payment period is 90 Days ".", Dial *126# and select “Lipa Na Bonga” and move to enter  Pay bill , Enter : (4029165) and Account Number : ".$booking_reference.",Enter Amount you wish to pay.  Terms & Conditions Apply";
                $this->sendMessage($message,$reciepient);
            ...
            $reciepient = $valid_phone;
            $message = "Booking of : ".$product->product_name." was successful. Total Price is KES ".number_format($product->product_price,2)." And the Payment period is 90 Days ".", Dial *126# and select “Lipa Na Bonga” and move to enter  Pay bill , Enter : (4029165) and Account Number :  ".$booking_reference.",Enter Amount : KES ".number_format($minDeposit,2);
            $this->sendMessage($message,$reciepient);
        ...
        if($showDiscount == 1){
            ...
            $message = "Booking of : ".$product->product_name." was successful. "."You recieved a discount of ".number_format($discount,2)." Total Price is KES ".number_format(($product->product_price - $discount),2)." And the Payment period is 90 Days,".", Dial *126# and select “Lipa Na Bonga” and move to enter  Pay bill , Enter : (4029165) and Account Number :  ".$booking_reference.", Enter Amount : KES ".number_format($request->initial_deposit,2) ." Terms & Conditions Apply";
            $this->sendMessage($message,$reciepient);
        
        }elseif($showDiscount == 0){

            $message = "Booking of : ".$product->product_name." was successful. Total Price is KES ".number_format($product->product_price,2)." And the Payment period is 90 Days,".", Dial *126# and select “Lipa Na Bonga” and move to enter  Pay bill , Enter : (4029165) and Account Number :  ".$booking_reference.", Enter Amount : KES ".number_format($request->initial_deposit,2)." Terms & Conditions Apply";
            $this->sendMessage($message,$reciepient);
    ...
    public function make_booking_bonga_account(Request $request)
    {
