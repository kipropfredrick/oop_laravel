    ...
    public function handle()
    {
        ...
        foreach($bookings as $booking){
            ...
            if($diff_in_hours == 48){
                ...
                $message = "Complete your booking for ".$booking->product->product_name.". Paybill 4040299 and account number : ".$booking->booking_reference.". Total amount is KSh.".$booking->total_cost.". You can pay any amount.";
