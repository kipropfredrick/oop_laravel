    ...
    @endif
     ...
     <div class="form-group">
            <label class="">Highlights</label>
                ...
                <textarea name="highlights" id="highlights1" class="form-control" placeholder="Enter Description" cols="30" rows="10" placeholder="Enter Product price" type="number" class="form-control @if($errors->has('highlights')) invalid_field @endif" > {!!$product->highlights!!}</textarea> 
                @error('highlights')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        <div class="form-group">
            <label class="">Description</label>
                 ...
                 <textarea name="description" id="description1" class="form-control" placeholder="Enter Description" cols="30" rows="10" placeholder="Enter Product price" type="number" class="form-control @if($errors->has('description')) invalid_field @endif" >
                     {!!$product->description!!}
                 </textarea>
                @error('description')
                            <div class="invalid-feedback">
