       ...
       @csrf
         <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select  onchange="get_subs()" name="category_id" required id="category_id" class="form-control select2 dynamic" data-dependent="subcategory_id" style="width: 100%;">
                    <option value="{{$product->ategory_id}}">{{$product->category->category_name}}</option>
            ...
            <label>Product Name</label>
                <input tclass="form-control" name="product_name" value="{{$product->product_name}}" placeholder="Enter Product name" type="text" class="form-control @if($errors->has('product_name')) invalid_field @endif" required>
            ...
            <label>Buying price</label>
                <input min="1" tclass="form-control" value="{{$product->buying_price}}" name="buying_price" placeholder="Enter Product Buying price" type="number" class="form-control @if($errors->has('buying_price')) invalid_field @endif" required>
            ...
            <div class="row">
             ...
             <div class="form-group">
               <label class="col-form-label">Selling price</label>
                <input min="1" tclass="form-control" name="product_price" value="{{$product->product_price}}" placeholder="Enter Product price" type="number" class="form-control @if($errors->has('product_price')) invalid_field @endif" required>
          ...
          <div class="form-group">
            <label class="col-form-label">Product Condition</label>
                ...
                <option value="{{$product->condition}}">{{ucfirst($product->condition)}}</option>
     ...
     <div class="row">
           ...
           <div class="form-group">
            <label class="">Product Weight</label>
                <input min="1" tclass="form-control" value="{{$product->weight}}" name="weight" placeholder="Enter Product weight" type="number" class="form-control @if($errors->has('weight')) invalid_field @endif" required>
            ...
            <div class="col-lg-6">
                ...
                <select tclass="form-control" name="unit"  type="" class="form-control @if($errors->has('unit')) invalid_field @endif" required>
                    <option value="{{$product->unit}}">@if($product->unit == "kg") Kilograms (Kg) @elseif($product->unit =="g") Grams (g) @endif</option>
