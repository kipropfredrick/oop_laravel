...
<div class="table-responsive">
        <div class="card-header header-elements-inline">
            <h6 style="color: #005b77;" class="card-title"><strong>Pickup Locations</strong></h6>
        </div>
        ...
        <form action="/admin/counties/locations/save" method="post">
          ...
          <legend class="text-uppercase font-size-sm font-weight-bold">Add Pickup Location</legend>
          ...
          <div class="form-group row">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="county_id" id="" required>
        ...
        <legend class="text-uppercase font-size-sm font-weight-bold">Pickuplocations</legend>
        ...
        <table class="table datatable-basic  table-striped">
						...
						<tbody>
							...
							<tr>
                                ...
                                <td>{{$location->county->county_name}}</td>
                                <td>{{$location->town}}</td>
