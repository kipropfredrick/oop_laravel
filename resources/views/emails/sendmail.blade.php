...
<body>
        ...
        <h1 style="background-color:#000;color:#FFF;padding:20px;width:100%">Combine</h1>
            ...
            <p>You had attempted to make a booking of :<strong>{{ $details['product_name'] }}</strong>, On combine.co.ke, The Product Price is  : <strong>KES  {{ $details['total_cost'] }}</strong>
