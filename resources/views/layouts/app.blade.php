...
<html lang="en">
    <head>
        ...
        fbq('init', '6262735097100629');
        fbq('track', 'PageView');
        </script>
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=6262735097100629&ev=PageView&noscript=1"
        /></noscript>
            ...
            <div class="hh-search">
                <form class="form-inline my-2" action="/search" method="get">
                    <div class="input-group">
                        <input name="search" type="text" class="form-control" placeholder="What are you looking for?" aria-label="What are you looking for?" aria-describedby="mdg-btn-search">
                        <div class="input-group-append">
                            <button class="mdg-btn-search" type="submit" id="mdg-btn-search">
                                <span class="fa fa-search"></span>
                            </button>
                        </div>
                    </div>
    ...
    <div class="copyrights">
        <div class="container">
            &copy; <span id="currentYear"></span>. <span style="color: white;">Mosmos Payments. All Rights Reserved.</span>
        </div>
    </div>
    <!-- end -->
