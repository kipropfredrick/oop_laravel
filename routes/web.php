...
Route::get('/{slug}','FrontPageController@category');
Route::get('/{category}/{subcategory}/{slug}','FrontPageController@thirdlevelcategory');
Route::post('/{category}/{subcategory}/{slug}','FrontPageController@thirdlevelcategory_load_more');
Route::post('/{slug}','FrontPageController@category_load_more');
...
Route::get('/{category}/{slug}','FrontPageController@subcategory')->name('view-subcategory');
Route::post('/{category}/{slug}','FrontPageController@subcategory_load_more');
